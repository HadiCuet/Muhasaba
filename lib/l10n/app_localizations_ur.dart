...
class AppLocalizationsUr extends AppLocalizations {
  ...
  @override
  String get targetAnyHelp => 'کوئی ہدف نہیں — کسی بھی مقدار پر مکمل شمار ہوگا';
  ...
  @override
  String get statsTotalCaption => 'کل';
  ...
  @override
  String get statsAmountPerDay => 'روزانہ مقدار';
  ...
  @override
  String get challengeSpreadLonger => 'زیادہ مدت';
  ...
  @override
  String get challengeGroupShape => 'قسم';

  @override
  String get challengeGroupPlan => 'منصوبہ';
  ...
  @override
  String get supportPromptLater => 'بعد میں یاد دلائیں';
  ...
  @override
  String get tipSheetSupporterAgain => 'جب چاہیں دوبارہ تعاون کر سکتے ہیں۔';

  @override
  String tipSheetStoreNote(String store) {
    return 'ادائیگی $store کے ذریعے ہوتی ہے — آپ کی ادائیگی کی تفصیلات ہم کبھی نہیں دیکھتے۔';
  }

  @override
  String get tipSheetOtherWays =>
      'کوئی ایسا آپشن نہیں مل رہا جو آپ کے لیے مناسب ہو؟';

  @override
  String get tipSheetWriteToUs => 'ہمیں لکھیں';
  ...
  @override
  String get tipFailed => 'خریداری مکمل نہیں ہو سکی۔ کوئی رقم نہیں کٹی۔';
  ...
  @override
  String get optionJamaaAlone => 'تنہا';

  @override
  String get optionJamaaHome => 'گھر میں جماعت';
  ...
  @override
  String get optionOnTimeLate => 'تاخیر سے';

  @override
  String get optionOnTimeQada => 'قضا';

  @override
  String get optionSetQuranSession => 'قرآن کی نشست';
  ...
  @override
  String get optionQuranMeaning => 'ترجمے کے ساتھ';

  @override
  String get optionQuranListened => 'سماعت';

  @override
  String get optionSetSadaqahType => 'صدقہ کی قسم';

  @override
  String get optionSadaqahMoney => 'رقم';

  @override
  String get optionSadaqahFood => 'کھانا';

  @override
  String get optionSadaqahTime => 'وقت';

  @override
  String get optionSadaqahOther => 'دیگر';

  @override
  String get optionSetIntensity => 'شدت';

  @override
  String get optionIntensityLight => 'ہلکا';

  @override
  String get optionIntensityModerate => 'درمیانہ';

  @override
  String get optionIntensityIntense => 'بھرپور';

  @override
  String get optionSetNewTitle => 'اختیارات کا نیا مجموعہ';

  @override
  String get optionSetEditTitle => 'اختیارات کے مجموعے میں ترمیم';

  @override
  String get optionSetNameLabel => 'مجموعے کا نام';

  @override
  String get optionSetNameHint => 'مثلاً جماعت';

  @override
  String get optionsLabel => 'اختیارات';

  @override
  String get optionAdd => 'اختیار شامل کریں';
  ...
  String optionsMaxReached(int max) {
    return 'زیادہ سے زیادہ $max اختیارات۔';
  }

  @override
  String get optionSetPreviewLabel => 'پیش نظارہ — آج کی قطار';

  @override
  String optionSetKeptForHistory(String labels) {
    return 'تاریخچے کے لیے محفوظ: $labels';
  }

  @override
  String get optionSetDelete => 'مجموعہ حذف کریں';

  @override
  String get optionSetDeleteConfirm =>
      'اس مجموعے والے اعمال میں اختیارات دکھائی نہیں دیں گے۔ جو دن آپ پہلے درج کر چکے ہیں، ان کا انتخاب محفوظ رہے گا۔';

  @override
  String get optionSetNameRequired => 'مجموعے کا نام درج کریں';
  ...
  @override
  String get optionSetNew => 'نیا مجموعہ';

  @override
  String get requireChoiceLabel => 'انتخاب لازمی';

  @override
  String get requireChoiceHelp =>
      'جب تک اختیار منتخب نہ ہو، قطار مکمل نہیں ہوگی';
  ...
  @override
  String get choiceNeeded => 'انتخاب درکار';
  ...
  String optionNotSelected(String label) {
    return '$label، غیر منتخب';
  }

  @override
  String optionBreakdownTitle(String set) {
    return 'اختیارات کی تفصیل — $set';
  }
  ...
  String optionNoChoiceRecorded(int none, int total) {
    String _temp0 = intl.Intl.pluralLogic(
      total,
      locale: localeName,
      other: '$total مکمل دنوں',
      one: 'ایک مکمل دن',
    );
    return 'انتخاب درج نہیں — $_temp0 میں سے $none';
  }
  ...
  @override
  String get optionBreakdownSectionTitle => 'اختیارات کی تفصیل';
  ...
  String get optionDetailEmpty =>
      'اس مجموعے کے لیے ابھی کوئی انتخاب درج نہیں ہوا۔';

  @override
  String get optionDetailTrendHeading => 'وقت کے ساتھ تبدیلی';

  @override
  String optionDetailTrendReadout(String option, String from, String to) {
    return 'پہلے اور آخری ہفتے کے درمیان $option کا تناسب $from سے $to ہو گیا۔';
  }

  @override
  String get optionDetailByAmalHeading => 'عمل کے لحاظ سے';
  ...
  String optionDetailByAmalReadout(
    ...
    return 'سب سے زیادہ: $best ($bestShare)؛ سب سے کم: $worst ($worstShare)۔';
  }

  @override
  String get optionDetailRecordsHeading => 'ریکارڈ';

  @override
  String get optionDetailLongestRun => 'طویل ترین سلسلہ';

  @override
  String get optionDetailBestWeek => 'بہترین ہفتہ';

  @override
  String get optionDetailCurrentRun => 'موجودہ سلسلہ';

  @override
  String get optionDetailRecordsCaption =>
      'گزشتہ ایک سال کی بنیاد پر؛ اوپر منتخب کردہ مدت سے قطع نظر۔';

  @override
  String get optionDetailRecentDaysHeading => 'حالیہ دن';
